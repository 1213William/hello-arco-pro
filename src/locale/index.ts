const i18n = {
  'en-US': {
    ...
    'menu.markdown.table': 'MarkDown Table',
    'menu.markdown.edit': 'MarkDown Edit',
    'menu.agGrid.agTable': 'AgTable',
    'menu.agGrid': 'agGrid',
  ...
  'zh-CN': {
    ...
    'menu.markdown': 'MarkDown',
    'menu.markdown.table': 'MarkDown 列表',
    'menu.markdown.edit': 'MarkDown 编辑',
    'menu.agGrid.agTable': 'AgTable',
    'menu.agGrid': 'agGrid',
    'navbar.logout': '退出登录',
    'settings.title': '页面配置',
